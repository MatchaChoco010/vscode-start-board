...
- [ ] 3.2 Extension ⇔ Webview間のメッセージ通信を実装する
...
- [ ] 5. ユーザー操作機能実装
- [ ] 5.1 現在のワークスペース/フォルダをプロジェクトとして追加するコマンドを実装する
...
- [ ] 6. 空ウィンドウ検出と自動表示
- [ ] 6.1 空のウィンドウを検出してダッシュボードを自動表示する
...
- [ ] 7. テストと検証
- [ ] 7.1 (P) ProjectStorageのユニットテストを実装する
